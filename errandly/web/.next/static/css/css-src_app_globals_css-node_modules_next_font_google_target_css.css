...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  :root {
    ...
    /* Errandly Brand Colors */
    --errandly-orange: #FF6B00;
    --errandly-orange-light: #FF8C3A;
    --errandly-orange-dark: #CC5500;
    --errandly-navy: #0A1628;
    --errandly-navy-light: #1A2E4A;
    --errandly-success: #16A34A;
    --errandly-warning: #D97706;
    --errandly-danger: #DC2626;
    --errandly-info: #2563EB;
  }
  * {
...
.border-\[\#FF6B00\]\/25 {
  border-color: rgb(255 107 0 / 0.25);
}
.border-\[\#FF6B00\]\/30 {
...
.bg-\[\#1A2E4A\] {
  --tw-bg-opacity: 1;
  background-color: rgb(26 46 74 / var(--tw-bg-opacity, 1));
}
.bg-\[\#FF6B00\] {
  --tw-bg-opacity: 1;
...
.bg-\[\#FF8C3A\] {
  --tw-bg-opacity: 1;
  background-color: rgb(255 140 58 / var(--tw-bg-opacity, 1));
}
.bg-amber-100 {
  --tw-bg-opacity: 1;
...
.to-\[\#1A2E4A\] {
  --tw-gradient-to: #1A2E4A var(--tw-gradient-to-position);
}
.to-\[\#FF6B00\] {
  --tw-gradient-to: #FF6B00 var(--tw-gradient-to-position);
}
.to-\[\#FF8C3A\] {
  --tw-gradient-to: #FF8C3A var(--tw-gradient-to-position);
}
.to-gray-700 {
...
.text-\[\#FF8C3A\] {
  --tw-text-opacity: 1;
  color: rgb(255 140 58 / var(--tw-text-opacity, 1));
}
.text-amber-400 {
  --tw-text-opacity: 1;
...
/* Custom Errandly styles */
.errandly-gradient {
  background: linear-gradient(135deg, #FF6B00 0%, #FF8C3A 50%, #FFB380 100%);
}

.errandly-hero-gradient {
  background: linear-gradient(135deg, #0A1628 0%, #1A2E4A 40%, #FF6B00 100%);
}
...
.errandly-btn-primary:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(204 85 0 / var(--tw-bg-opacity, 1));
}

.errandly-btn-primary:active {
  --tw-scale-x: .95;
  --tw-scale-y: .95;
  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
}

.errandly-btn-secondary {
  border-radius: 12px;
  border-width: 2px;
  --tw-border-opacity: 1;
  border-color: rgb(255 107 0 / var(--tw-border-opacity, 1));
...
.hover\:bg-\[\#223550\]:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(34 53 80 / var(--tw-bg-opacity, 1));
}
...
.focus\:ring-\[\#FF6B00\]:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(255 107 0 / var(--tw-ring-opacity, 1));
}
.focus\:ring-\[\#FF6B00\]\/30:focus {
  --tw-ring-color: rgb(255 107 0 / 0.3);
}
.focus\:ring-\[\#FF6B00\]\/40:focus {
  --tw-ring-color: rgb(255 107 0 / 0.4);
}
