  ...
  return (
    <div className="p-4 pb-24 max-w-lg mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/runner/profile" className="p-2 rounded-lg hover:bg-gray-100">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <h1 className="font-bold text-xl text-[#0A1628]">Runner verification</h1>
      </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="space-y-4 bg-white rounded-2xl border border-gray-100 p-4">
            <select value={idType} onChange={(e) => setIdType(e.target.value)} className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm">
              {ID_TYPES.map((t) => (
            ...
            <input value={idNumber} onChange={(e) => setIdNumber(e.target.value)} placeholder="ID number" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm" />
            <input value={ninNumber} onChange={(e) => setNinNumber(e.target.value)} placeholder="NIN" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm" />
            <input value={bvnNumber} onChange={(e) => setBvnNumber(e.target.value)} placeholder="BVN" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm" />
            <input value={idDocumentUrl} onChange={(e) => setIdDocumentUrl(e.target.value)} placeholder="ID document URL" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm" />
            <input value={selfieUrl} onChange={(e) => setSelfieUrl(e.target.value)} placeholder="Selfie URL" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm" />
